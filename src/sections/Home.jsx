...
import avater from '../assets/avator.png'
...
const Home = () => {
  ...
  const roles = useMemo(() => ["Web Developer", "Frontend Developer", "Web Designer", "React Developer"])
      ...
      <div className='relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 '>
        ...
        <div className='flex flex-col justify-center h-full text-center lg:text-left relative '>
          <div className='w-full lg:pr-24 mx-auto max-w-3xl'>
            ...
            >I turn complex ideas into clean, scalable, and high-performance web experiences that feel fast, intuitive, and impactful.</motion.p>
            ...
            >
              ...
              <a href="/Sadat Shahriar Rafin Frontend Developer.pdf"
                download
                className='px-6 py-3 rounded-full text-lg font-medium text-black bg-white hover:bg-gray-200 shadow-lg hover:scale-105 transition-all'
              >My Resume</a>
            </motion.div>

            <div className='mt-10 ml-5 flex gap-7 text-2xl md:text-3xl justify-center lg:justify-start'>
